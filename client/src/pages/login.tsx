        ...
        <div className="rounded-3xl bg-white/70 backdrop-blur border border-white shadow-[0_25px_80px_rgba(15,23,42,0.12)] p-10 flex flex-col justify-between">
          ...
          <div className="grid sm:grid-cols-3 gap-4 text-sm">
            ...
            <div className="rounded-2xl bg-slate-50 border p-4">
              ...
              <div className="mt-2 text-slate-600">`admin / Admin@123456`</div>
            </div>
          </div>
        </div>
          ...
          <CardContent>
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="rounded-2xl bg-slate-50 border p-4 text-sm text-slate-600">
                首次预览账号：
                <div className="mt-2 font-medium text-slate-900">用户名 `admin`</div>
                <div className="font-medium text-slate-900">密码 `Admin@123456`</div>
              </div>
            </form>
          </CardContent>
        </Card>
