...
CORE_PERMISSION_DEFINITIONS = [
    ("settlement.cosmetics_matching.view", "查看化妆品付款配票", "settlement", "cosmetics_matching_view"),
    ("settlement.cosmetics_matching.create", "生成化妆品付款配票", "settlement", "cosmetics_matching_create"),
    ("sales.new_century_payments.view", "查看新世纪支付方式销售毛利报表", "sales", "new_century_payments_view"),
    ("sales.self_operated.import", "导入自营服装销售", "sales", "self_operated_import"),
    ...
    ("sales.inventory_turnover.view", "查看商品周转财务月报", "sales", "inventory_turnover_view"),
    ...
    (
        "settlement.joint_payment_confirmation.view",
        "查看联营付款单确认",
        "settlement",
        "joint_payment_confirmation_view",
    ),
