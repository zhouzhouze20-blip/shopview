    ...
    if has_order_point:
        ...
        LEFT JOIN (
          SELECT
            ...
            STRING_AGG(point_type, '、' ORDER BY point_type) AS point_type
          FROM order_point
        ...
        point_type_expr = "MAX(op.point_type) AS point_type"
    else:
        point_expr = "0 AS point"
        point_type_expr = "NULL::varchar AS point_type"
    if has_salehead and dj_kind_col:
        txn_expr = f"""
          MAX(
