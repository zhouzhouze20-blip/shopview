...
import { ChevronLeft, ChevronRight, FileText, HardHat, Map as MapIcon, MapPin, RefreshCw } from "lucide-react";
...
export default function ContractsPage({
  ...
  useEffect(() => {
    if (!floorId && floorOptions.length) {
      setFloorId(floorOptions[0].id);
    }
  }, [floorId, floorOptions]);
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Select
              ...
              disabled={floorsQuery.isLoading}
            >
              <SelectTrigger>
