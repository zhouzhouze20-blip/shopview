...
function SystemOverview({
  ...
  return (
    ...
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-slate-900">经营概览</h1>
              ...
              <>
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  <div>
                    ...
                    <div className="text-2xl font-bold tabular-nums">{homeMoney(currAgg.effective_sales)}</div>
                  </div>
                  <div>
                    <div className="text-xs text-muted-foreground">毛利</div>
                    <div className="text-2xl font-bold tabular-nums text-slate-900">{homeMoney(currAgg.net_profit)}</div>
                  </div>
                  <div>
