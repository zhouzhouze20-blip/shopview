...
import { Building2, Users, FileText, CreditCard, BarChart3, Settings, ChevronLeft, Truck, HardHat } from "lucide-react";
...
export default function NavigationSidebar({ activeModule = "dashboard", onModuleChange, isCollapsed = false, onToggleCollapse }: NavigationSidebarProps) {
  const [expandedItems, setExpandedItems] = useState<string[]>(["tenant-management", "contract-management", "sales-management", "system-management", "floor-base-definitions"]);
