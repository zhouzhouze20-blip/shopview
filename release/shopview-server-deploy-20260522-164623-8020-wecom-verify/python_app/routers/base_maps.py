...
async def create_base_map(
    body: BaseMapCreate,
    db: Session = Depends(get_db),
    _=Depends(require_permission_dependency("base_map.create")),
):
...
async def activate_base_map(
    base_map_id: int,
    db: Session = Depends(get_db),
    _=Depends(require_permission_dependency("base_map.edit")),
):
...
async def delete_base_map(
    base_map_id: int,
    db: Session = Depends(get_db),
    _=Depends(require_permission_dependency("base_map.delete")),
):
