...
/** 与后端 counter_groups 关联门店一行一条，用于业务范围配置（与合同/销售数据口径一致） */
            ...
            {contractPermissionForm.scope_mode === "CUSTOM" && (
              <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-4 items-start">
                ...
                <div className="space-y-2 min-w-0">
                  <Label>门店 / 部门 / 柜组（同源：counter_groups 关联门店）</Label>
                    ...
                    <p className="text-xs text-muted-foreground border rounded-md p-3 bg-slate-50">
                      {contractScopeMatrixEffective.length === 0
                        ? "系统中暂无柜组（counter_groups）。请先同步 ERP 或导入柜组后再配置。"
                        : "当前勾选门店在柜组表中没有带部门编码的柜组记录。请核对 counter_groups.store_id、department_code 和 group_code。"}
                    </p>
		                  ) : (
