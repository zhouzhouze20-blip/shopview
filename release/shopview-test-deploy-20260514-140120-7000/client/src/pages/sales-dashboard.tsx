...
export default function SalesDashboardPage() {
  ...
  const departmentsQuery = useQuery<DepartmentSummary[]>({
    ...
    enabled: activeTab === "departments" || activeTab === "groups" || activeTab === "tickets",
  });
  ...
  const groupsQuery = useQuery<GroupSummary[]>({
    ...
    enabled: activeTab === "groups" || activeTab === "tickets",
  });
  ...
  const refresh = () => {
    storesQuery.refetch();
    if (activeTab === "departments" || activeTab === "groups" || activeTab === "tickets") departmentsQuery.refetch();
    if (activeTab === "groups" || activeTab === "tickets") groupsQuery.refetch();
