...
export default function ActivityAnalysisPage() {
  ...
  const overviewQuery = useQuery<ActivityOverview>({
    queryKey: ["/api/activity-analysis/overview", activityId, analysisScope],
    queryFn: () =>
      apiGet(
  ...
  const couponFlowsQuery = useQuery<RowData[]>({
    queryKey: ["/api/activity-analysis/coupon-flows", activityId, analysisScope, flowKeyword],
    queryFn: () =>
      apiGet(
  ...
  const qualityIssuesQuery = useQuery<RowData[]>({
    queryKey: ["/api/activity-analysis/quality-issues", activityId, analysisScope, issueType],
    queryFn: () =>
      apiGet(
